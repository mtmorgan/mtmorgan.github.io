...
The property is mostly wooded now. Hardwoods appear as relatively
light green in the image, in the north west near the Hill cabin and in
the north east corner of the property. Part of the land south and east
of the Pond cabin is a pine plantation. The topo map shows a fairly
extensive cedar swamp surrounding small streams running through the
property.
...
<figure>
    <img src="./images/topo-map-image-layer.jpg" width="100%"/>
    <br />
    <img src="./images/topo-map.jpg" width="100%"/>
    <figcaption>
    Our woods, from topographic maps generated by Ontario's <a
    href="https://www.ontario.ca/page/topographic-maps">Ministry of
    Natural Resources</a>.
    </figcaption>
</figure>
...
The animation below displays the images in the order they were
encountered, delayed in proportion to the time between pictures. So it
is like we are encountering them in a virtual forest. Each image
starts small, and grows in size as though one is walking toward
it. Then we zoom in to the center of the picture, because often the
texture is really fascinating. Sometimes the focus isn't so good
:(. Images appear, grow, and zoom at a more-or-less random cell on a
fixed 4 x 2 grid. Choice of cells is adjusted to avoid overlap between
